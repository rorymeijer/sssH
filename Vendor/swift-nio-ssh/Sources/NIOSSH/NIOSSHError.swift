...
extension NIOSSHError {
    ...
    /// The default answer to a keyboard-interactive challenge: a delegate that
    /// has not implemented the callback declines the method rather than
    /// stalling the connection.
    public static let unsupportedUserAuthenticationMethod = NIOSSHError(type: .unsupportedUserAuthenticationMethod, diagnostics: nil)
...
extension NIOSSHError {
    ...
    public struct ErrorType {
        ...
        /// An authentication method was offered that this side cannot complete.
